...
var import8 = require('./app.css.shim');
var import9 = require('../../app/alsu/code-blocks/code-blocks.component');
var import10 = require('./alsu/code-blocks/code-blocks.component.ngfactory');
...
var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_0 = import3.createRenderElement(this.renderer, parentRenderNode, 'div', new import3.InlineArray2(2, 'class', 'app'), null);
        this._el_1 = import3.createRenderElement(this.renderer, this._el_0, 'code-blocks', import3.EMPTY_INLINE_ARRAY, null);
    ...
    View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import9.CodeBlocksComponent) && (1 === requestNodeIndex))) {
            return this._CodeBlocksComponent_1_3.context;
        }
        return notFoundResult;
    };
